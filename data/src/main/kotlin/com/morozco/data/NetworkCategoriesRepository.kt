...
class NetworkCategoriesRepository(
    ...
    override suspend fun getSubCategories(subCategory: String): Result<SubCategoryDataResponse> =
        api.getSubCategories(category = subCategory, offset = 0, limit = 25).toResult()
...
class SubCategoriesPagingSource(
    ...
    override fun getRefreshKey(state: PagingState<Int, SubCategoryData>): Int? = state.anchorPosition
