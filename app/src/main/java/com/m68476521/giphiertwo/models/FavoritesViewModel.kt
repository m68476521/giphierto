...
class FavoritesViewModel(repository: GiphRepository) : ViewModel() {
    val favorites: LiveData<List<Image>> = repository.allFavorites.asLiveData()
}

class FavoriteViewModelFactory(private val repository: GiphRepository) : ViewModelProvider.Factory {
